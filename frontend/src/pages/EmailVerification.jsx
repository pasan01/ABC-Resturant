...
const EmailVerification = () => {
  ...
  return (
    <div className="authentication-bg" style={{ backgroundColor: '#535250', minHeight: '100vh' }}>
      <Alert />
      <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '100vh' }}>
        <div className="card shadow-sm" style={{ width: '100%', maxWidth: '400px', backgroundColor: '#535250', border: 'none' }}>
