...
const Login = () => {
  ...
  return (
    <div className="authentication-bg" style={{ backgroundColor: '#535250', padding: '3rem 1rem'  }}>
      <Alert />
      <div className="account-pages pt-4 pb-4">
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-6 col-lg-5">
              <div className="card shadow-lg p-4" style={{ backgroundColor: '#535250', color: 'black' }}>
